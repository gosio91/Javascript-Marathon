...
function typeValidation(variable, type){
   ...
   let outcome = boo===type ? true:false
...
function tripleCombine(str1,str2,str3){
...
function bandName(str){
    ...
    let propName =str[0].toUpperCase()+str.slice(1);

    if(str[0]===str[str.length-1]){

        bandName= propName+str;

    } else{

        bandName = `The ${propName}`;
